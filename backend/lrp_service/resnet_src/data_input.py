...
def distorted_inputs(data_dir, batch_size, num_tags=17):
  ...
  #                                        shuffle=True)
  images, label_batchs = _generate_image_and_label_batch(float_image, read_input.label,
                                         min_queue_examples, batch_size,
                                         shuffle=True)
  print("images:",type(images),images.shape)
  return images, label_batchs
...
# sess = tf.Session()
# # sess.run(init_op)
# images, labels = distorted_inputs(data_dir = '../data/tfrecords', batch_size = 32, num_tags=17)
# # array = images.eval(session=sess)
# print("sess.run:")
# array = sess.run(labels)
# print("array:")
# print(array)
